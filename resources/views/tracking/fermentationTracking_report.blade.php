...
<body>
    ...
    <div class="title">
        <h2>Reporte del seguimiento de la fermentación</h2>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            @foreach($records as $record)
                <tr>
                    <td>{{ $record->name_of_tracking }}</td>
                    <td>{{ $record->harvest->name ?? 'Sin asignar' }}</td>
                    <td>{{ $record->weight   }}Lb</td>
                    <td>{{ $record->B_weight }}Lb</td>
                    <td>{{ $record->total_weight }}Lb</td>   
